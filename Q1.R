...
######### Amazon URL ###########
aurl <- "https://www.amazon.in/Test-Exclusive-614/product-reviews/B07HGJJ559/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews"
amazon_reviews <- NULL
...
write.table(amazon_reviews,"samsung.txt")
getwd()
...
x1 <- tm_map(x1, removeWords, c('phone','samsung','mah','dont','will'))
x1 <- tm_map(x1, stripWhitespace)
